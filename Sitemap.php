...
class Sitemap
{
     ...
     * @throws \InvalidArgumentException
     */
    public function addItem($location, $lastModified = null, $changeFrequency = null, $priority = null,$arrPictures = [])
    {
     ...
     * @param string $priority item's priority (0.0-1.0). Default null is equal to 0.5
     * @param Array url pictures example array(array("url" => "url picture","caption" => "picture name"));
     *
     * @throws \InvalidArgumentException
     *
     * @see addItem
     */
    private function addSingleLanguageItem($location, $lastModified, $changeFrequency, $priority,$arrPictures = [])
    {
        ...
        if(!empty($arrPictures)){
            foreach($arrPictures as $pic){
                $this->writer->startElement("image:image");
                    $this->writer->writeElement("image:loc",$pic["url"]);
                    $this->writer->writeElement("image:caption",$pic["caption"]);
                $this->writer->endElement();
            }
        }
